...
export default function PresetsPage() {
  const presets = [
    { name: 'Warm Vocals', category: 'Vocal', downloads: '5K' },
    { name: 'Punchy Drums', category: 'Drums', downloads: '8K' },
    { name: 'Deep Bass', category: 'Bass', downloads: '6K' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-6">
              ...
              <Link href="/presets" className="text-indigo-600 font-medium">Presets</Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-2 flex items-center gap-3">
          <AdjustmentsHorizontalIcon className="w-10 h-10 text-indigo-600" />
          Effect Presets
        </h1>
        <p className="text-gray-600 mb-8">Ready-to-use effect presets</p>
          ...
          {presets.map((preset, idx) => (
            <div key={idx} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all">
              <div className="w-full h-32 bg-gradient-to-br from-indigo-200 to-purple-200 rounded-xl mb-4 flex items-center justify-center">
                <AdjustmentsHorizontalIcon className="w-12 h-12 text-indigo-600" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-1">{preset.name}</h3>
              <p className="text-gray-600 mb-4">{preset.category} • {preset.downloads} downloads</p>
